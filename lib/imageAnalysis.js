...
export async function iaShow(wid, analysisId, { ttl = 900 } = {}) {
  if (!wid) throw new Error("Workspace id is required for iaShow");
  return req(`/workspaces/${wid}/image-analysis/${analysisId}?presign=1&ttl=${ttl}`);
}
