...
const SHOW = [
  {
    ...
    results: {
      baseline: {
        ...
        colors: [
          { finish: "Glossy", base: "RED", lightness: "DARK", conf: 0.93 },
          { finish: null, base: "BLACK", lightness: null, conf: 0.88 },
        ],
        plate_text: "ABC1234",
        // NEW: plate confidence + plate image
        plate_conf: 0.98,
        plate_image: {
          s3_key: `imageanalysis/${WID}/101/baseline/plate.jpg`,
          url: "https://via.placeholder.com/480x120?text=PLATE+ABC1234",
        },
        annotated_image: {
      ...
      cmt: {
        ...
        plate_conf: 0.98,
        plate_image: {
          s3_key: `imageanalysis/${WID}/101/cmt/plate.jpg`,
          url: "https://via.placeholder.com/480x120?text=PLATE+ABC1234",
        },
        annotated_image: {
...

  {
    ...
    results: {
      baseline: {
        ...
        colors: [
          { finish: null, base: "WHITE", lightness: null, conf: 0.95 },
          { finish: null, base: "BLACK", lightness: null, conf: 0.65 },
        ],
        plate_text: "NDB5678",
        plate_conf: 0.94,
        plate_image: {
          s3_key: `imageanalysis/${WID}/102/baseline/plate.jpg`,
          url: "https://via.placeholder.com/480x120?text=PLATE+NDB5678",
        },
        annotated_image: {
      ...
      cmt: {
        ...
        plate_conf: 0.94,
        plate_image: {
          s3_key: `imageanalysis/${WID}/102/cmt/plate.jpg`,
          url: "https://via.placeholder.com/480x120?text=PLATE+NDB5678",
        },
        annotated_image: {
...

  {
    ...
    results: {
      baseline: {
        ...
        colors: [
          { finish: "Matte", base: "BLUE", lightness: "DARK", conf: 0.90 },
          { finish: null, base: "BLACK", lightness: null, conf: 0.60 },
        ],
        plate_text: "",
        plate_conf: null,
        plate_image: null,
...

  {
    ...
    results: {
      baseline: {
        ...
        colors: [
          { finish: null, base: "BLACK", lightness: null, conf: 0.94 },
          {
            finish: "Metallic",
            base: "SILVER",
            lightness: "LIGHT",
        ...
        plate_conf: 0.96,
        plate_image: {
          s3_key: `imageanalysis/${WID}/104/baseline/plate.jpg`,
          url: "https://via.placeholder.com/480x120?text=PLATE+TXM2345",
        },
        annotated_image: {
      ...
      cmt: {
        ...
        plate_conf: 0.96,
        plate_image: {
          s3_key: `imageanalysis/${WID}/104/cmt/plate.jpg`,
          url: "https://via.placeholder.com/480x120?text=PLATE+TXM2345",
        },
        annotated_image: {
...

  {
    ...
    results: {
      baseline: {
        ...
        colors: [
          { finish: "Glossy", base: "BLUE", lightness: "DARK", conf: 0.91 },
          { finish: null, base: "BLACK", lightness: null, conf: 0.70 },
        ],
        plate_text: "MC-7789",
        plate_conf: 0.92,
        plate_image: {
          s3_key: `imageanalysis/${WID}/105/baseline/plate.jpg`,
          url: "https://via.placeholder.com/480x120?text=PLATE+MC-7789",
        },
        annotated_image: {
      ...
      cmt: {
        ...
        plate_conf: 0.92,
        plate_image: {
          s3_key: `imageanalysis/${WID}/105/cmt/plate.jpg`,
          url: "https://via.placeholder.com/480x120?text=PLATE+MC-7789",
        },
        annotated_image: {
...
// ===== Public mock API for Image Analysis =====

export async function iaList(_wid) {
  await delay(150);
...
export async function iaPresign(_wid, { filename, content_type }) {
  ...
  return {
    ...
    url: "https://example.invalid/presigned-put-mock",
    content_type: content_type || "image/jpeg",
    max_bytes: 25 * MB,
  };
}

// Simulated PUT progress (UI will not error while offline)
...
// ===========================================================================
// Legacy detection mocks used by /app/api/proxy/detections/*
// These keep the old proxy routes compiling under Next 16 / Turbopack.
// They are safe stubs and are not used by the modern video-analysis flow.
// ===========================================================================

const DETECTIONS = [];

export async function listDetections(_params = {}) {
  await delay(50);
  return {
    items: [...DETECTIONS],
    total: DETECTIONS.length,
    page: 1,
    perPage: DETECTIONS.length || 50,
  };
}
...
export async function patchDetection(id, payload) {
  await delay(80);
  const idx = DETECTIONS.findIndex((d) => d.id === id);
  if (idx >= 0) {
    DETECTIONS[idx] = { ...DETECTIONS[idx], ...payload };
...
export async function requestEvidence(id) {
  await delay(80);
  return {
    id,
    status: "queued",
