      ...
      <div
        ...
        <div className="relative z-10 flex items-center justify-center">
          <div
            ...
            <span className="dark:text-white text-black z-20 text text-2xl">{text}</span>
          </div>
        </div>
      </div>
    </div>
...
export function CardPattern({
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-orange-500 to-cyan-500 opacity-0  group-hover/card:opacity-100 backdrop-blur-xl transition duration-500"
        style={style} />
      <motion.div
